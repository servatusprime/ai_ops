...
Copilot also reads `.github/copilot-instructions.md` for project-level custom
instructions. No dedicated setup script; use natural language invocation.
...
| GitHub Copilot | Instructions | `.github/copilot-instructions.md` | Natural language |
