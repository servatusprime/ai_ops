...
| --- | --- |
| `PARK` | Agent saves state and halts. `approval_state` → `TIMED_OUT`. Work remains queued for future resume. |
...
```yaml
approval_contract:
  request_id: "wb_platform_governance_uplift_01-phase2"
  ...
  context_snapshot_path: "90_Sandbox/ai_workbooks/wb_platform_governance_uplift_01_2026-04-12/wb_platform_governance_uplift_01.md"
  approved_by: null
  approved_at: null
```
...
- 1.0.1 (2026-05-04): §2 — replaced "recommended" with SHOULD per spec language standard (`specs/README.md` §Spec Characteristics).
